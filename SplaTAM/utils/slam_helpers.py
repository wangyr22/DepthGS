...
def _transform_to_frame(params, pose, gaussians_grad, camera_grad):
    """
    this is MODIFIED to accept pose as input.
    Function to transform Isotropic or Anisotropic Gaussians from world frame to camera frame.
